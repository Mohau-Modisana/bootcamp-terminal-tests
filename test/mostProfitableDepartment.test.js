...
it('should show return "Most profitable department is "outdoor" for dataset 1" for departments that are the most profitable in salesData' , function(){
    assert.equal('outdoor', mostProfitableDepartment(salesData), "Most profitable department is 'outdoor' for dataset 1");

});

it('should show return "Most profitable department is "electronics" for dataset 2" for departments that are the most profitable in salesData2' , function(){
